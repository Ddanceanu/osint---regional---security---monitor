...
// Muted, desaturated palette for Theme Shift stacked bars
export const THEME_SHIFT_COLORS = {
    support_ukraine:               '#4A7FB5',
    eastern_flank_nato_deterrence: '#7B6BA6',
    romania_republic_of_moldova:   '#B8845A',
    russia_regional_implications:  '#B56060',
    eu_regional_security:          '#4A9E78',
    black_sea_regional_security:   '#5A8EA6',
    other_mixed:                   '#5C6B7E',
};
